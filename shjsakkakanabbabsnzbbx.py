...
Copyright © 2022 Asepitgans<vakumhacker@gmail.om>
...
logging.addLevelName(60, "\033[42mSUCCES\033[0m")
...
if __name__ == "__main__":
    ...
    parser = ArgumentParser(
      ...
      epilog="Copyright © 2022 Asepitgans",
    )
    ...
    try:
        ...
        with ThreadPoolExecutor(max_workers=args.thread) as executor:
            ...
            if success_login is True:
                log.success("-> \033[32msuccessfully entered into the target dashboard with username\033[0m \""+args.usr+"\" and password \""+password+"\"")
            else:
